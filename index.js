...
function trimProperties(obj) {
  const returnObj = {...obj};
  return trimPropertiesMutation(returnObj);
}
...
class Counter {
  ...
  constructor(initialNumber) {
    const genMaker = function* (initialNuber){ // trying to use generators
    ...
    this.generator = genMaker(initialNumber);
  }
